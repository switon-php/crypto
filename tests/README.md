# Switon Crypto Package Tests

Test suite for the Switon Crypto package, organized by test type and speed.
...
- Follow naming convention: `Crypto[Component]Test.php`
