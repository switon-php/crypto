...
Security fixes are provided for **currently supported release lines** of `switon/crypto` (`switon/crypto` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/crypto/security/advisories/new)
